# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 12:36:34 2025
...
m.x = pyo.Var(m.node_pairs, m.V, m.T, within = pyo.Binary)
...
def edges_1_rule(m,i,v,t):
    ...
    return sum(m.x[i,j,v,t]+m.x[j,i,v,t] for j in m.Nt if i != j) == 2 * m.z[i,v,t]
